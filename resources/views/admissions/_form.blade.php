...
@endpush
    ...
    <div class="col-md-2">
        ...
        <select id="patient_type" name="patient_type"
            ...
            <option value="">— {{ __('Optional') }} —</option>
            <option value="pension"  {{ old('patient_type', $admission->patient_type ?? '') === 'pension'  ? 'selected' : '' }}>{{ __('Pension') }}</option>
            <option value="student"  {{ old('patient_type', $admission->patient_type ?? '') === 'student'  ? 'selected' : '' }}>{{ __('Student') }}</option>
